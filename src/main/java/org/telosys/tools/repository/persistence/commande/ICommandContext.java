...
public interface ICommandContext {
	...
	boolean accept(final ProcessContext processContext);
	
	ProcessContext runProcess(final ProcessContext processContext, final ICommandManager iCommandManager) throws CommandException;
