...
public class CommandElementLink extends AbstractCommand implements ICommandContext {
...
//			} else 
		...
		// Return result
		final ProcessContext context = new ProcessContext(link);
		return context;
	}

	public boolean accept(final ProcessContext processContext) {
		return genericAccept(processContext, RepositoryConst.LINK);
	}
