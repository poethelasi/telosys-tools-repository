...
public class CommandElementGeneratedValue extends AbstractCommand implements ICommandContext {
	...
	public boolean accept(final ProcessContext processContext) {
		return genericAccept(processContext, RepositoryConst.GENERATED_VALUE_ELEMENT);
	}
