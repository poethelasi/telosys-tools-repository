...
public class CommandElementColumn extends AbstractCommand implements ICommandContext {
	...
	public ProcessContext runProcess(final ProcessContext processContext, final ICommandManager iCommandManager) throws CommandException {
		...
		// Return result
		final ProcessContext context = new ProcessContext(column);
		return context;
	}

	public boolean accept(final ProcessContext processContext) {
		return genericAccept(processContext, RepositoryConst.COLUMN);
	}
